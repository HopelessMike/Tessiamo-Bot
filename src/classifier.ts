...
export async function isOnTopic(text: string): Promise<boolean> {
  const prompt = `Classifica se la seguente richiesta è ATTINENTE al dominio "tessuti, stampa su tessuto, qualità, usi consigliati, prodotti Tessiamo, catalogo Tessiamo".
